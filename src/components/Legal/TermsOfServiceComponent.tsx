    ...
    <div className="flex flex-1 w-full items-center flex-col mt-5 py-16 px-8">
      <div className="container">
        ...
        <p className="md:text-lg text-sm text-gray-500 2xl:text-2xl leading-normal mb-3">
          ...
          security features and it could mean that the Stocker app won`t work
          properly or at all.
        </p>
        <p className="md:text-lg text-sm text-gray-500 2xl:text-2xl leading-normal mb-3">
          {" "}
        ...
        <p className="md:text-lg text-sm text-gray-500 2xl:text-2xl leading-normal mb-3">
          ...
          can be Wi-Fi or provided by your mobile network provider, but Stocker
          Team cannot take responsibility for the app not working at full
        ...
        <p className="md:text-lg text-sm text-gray-500 2xl:text-2xl leading-normal mb-3">
          ...
          from the bill payer for using the app. Along the same lines, Stocker
          Team cannot always take responsibility for the way you use the app
          i.e. You need to make sure that your device stays charged - if it runs
          out of battery and you can`t turn it on to avail the Service, Stocker
          Team cannot accept responsibility.
        </p>
        <p className="md:text-lg text-sm text-gray-500 2xl:text-2xl leading-normal mb-3">
          {" "}
          With respect to Stocker Team`s responsibility for your use of the app,
        ...
        <p className="md:text-lg text-sm text-gray-500 2xl:text-2xl leading-normal mb-3">
          ...
          want to keep using the app. Stocker Team does not promise that it will
