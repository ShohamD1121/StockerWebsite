    ...
    <React.Fragment>
      <div className="flex flex-1 w-full items-center flex-col mt-5 py-16 px-8">
        <div className="container">
          ...
          <p className="md:text-lg text-sm text-gray-500 2xl:text-2xl leading-normal mb-4">
            {" "}
          ...
          <p className="md:text-lg text-sm text-gray-500 2xl:text-2xl leading-normal mb-3">
            ...
            our Terms and Conditions, which are accessible at Stocker unless
          ...
          <ol className="ml-6 mb-3 list-disc">
            <li className="mb-1">To facilitate our Service.</li>
            <li className="mb-1">To provide the Service on our behalf.</li>
            <li className="mb-1">To perform Service-related services.</li>
            <li className="mb-1">
